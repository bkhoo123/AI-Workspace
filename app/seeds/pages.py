    ...
    pages = [    
        {
            ...
            'content': {
                "ops": [
                    ...
                    {"insert": "See the buttons up top? You can use AI Workspace to make your workflow easier.\n"},
                    ...
                    {"insert": "Story Time will have AI Workspace create a story for you based on the topic you choose in the prompt\n"},
        ...
        },
        {
            ...
            'content': {
                "ops": [
                    {"insert": "For When You're Out of Ideas AI Workspace can take care of the creative process for you. \n", "attributes": {"header": 1}},
                    {"insert": "\n"},
        ...
        },
        {
            ...
            'content': {
                "ops": [
                    {"insert": "AI Workspace can Generate Journal Prompts for you. \n", "attributes": {"header": 1}},
                    {"insert": "\n"},
